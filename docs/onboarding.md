...
| `constants/`          | `api-routes.ts` (one enum per route group — `AuthRoutes`, `ExampleRoutes`), `queryKeys.ts` (the global `QueryKey` enum — every TanStack Query key in the app), `config.ts`, `env.ts` (the Zod-validated `import.meta.env` wrapper — see § 1).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |

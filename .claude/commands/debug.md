---
description: Diagnose a frontend runtime bug (wrong render, stale/inconsistent state, a query refetch loop, a perceived perf regression) that isn't a blocked commit.
argument-hint: '<what is broken + how to reproduce it>'
allowed-tools: Read, Grep, Edit, Bash(pnpm run *), Bash(pnpm exec *)
---

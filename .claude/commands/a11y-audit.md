---
description: Audit a component/route for WCAG 2.1 AA violations and report in plain language.
argument-hint: '<component path or route>'
allowed-tools: Read, Bash(npx *), Bash(npm run *)
---
...
1. Run the strict a11y lint pass: `npx eslint --config eslint.a11y.config.js <path>`.

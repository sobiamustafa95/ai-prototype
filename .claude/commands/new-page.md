---
description: Scaffold a full page from a design reference, decomposed into its constituent pieces.
argument-hint: '<PageName> [role or common]'
allowed-tools: Read, Write, Edit, Bash(pnpm run *), Bash(pnpm exec *)
---

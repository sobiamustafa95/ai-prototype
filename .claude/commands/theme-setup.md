---
description: Establish or substantially re-theme this project's brand — the one-time, project-wide @theme token pass.
argument-hint: '[optional: screenshot/Figma/pen.dev reference, or a description of the brand]'

---
description: Check bundle/render performance for a feature or the whole app.
argument-hint: '[optional: feature or file path]'
allowed-tools: Read, Bash(pnpm run *), Bash(pnpm exec *)
---
